...
import footerlogo from "../../public/svg/prepsathilogo2.svg";
      ...
      <div className="footer-content-column">
        <div className="footer-logo">
          <a className="footer-logo-link" href="#">
              <Image src={footerlogo} alt='footerlogo' className='h-auto w-52'/>
          </a>
        </div>
    ...
    <div className="footer-copyright">
      <div className="footer-copyright-wrapper">
        <p className="footer-copyright-text">
          <a className="footer-copyright-link" href="#" target="_self"> ©2024. | Designed By: Priyanka Bedwal. | All rights reserved. </a>
        </p>
      </div>
    </div>
  </footer>
